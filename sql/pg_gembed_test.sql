...
SELECT vector_dims(embed_text('embed_anything', 'Qdrant/all-MiniLM-L6-v2-onnx', 'Hello world'));

-- Batch text embedding
SELECT array_length(embed_texts('embed_anything', 'Qdrant/all-MiniLM-L6-v2-onnx', ARRAY['Hello', 'World']), 1);

-- Text embedding with IDs
SELECT id, vector_dims(embedding) FROM embed_texts_with_ids('embed_anything', 'Qdrant/all-MiniLM-L6-v2-onnx', ARRAY[1, 2], ARRAY['Hello', 'World']);
...
\set image_path '/Users/joeldiaz/dev/pg_gembed/image/Geralt.jpg'
...
\set repo_root '/Users/joeldiaz/dev/pg_gembed/image'
